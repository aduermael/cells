...
const COLLECTIONS = {
  all: [
    ...
    'zoom-selection-alignment.test.mjs',
    'zoom-dynamic.test.mjs',
    'zoom-comprehensive.test.mjs',
    'cell-background.test.mjs',
    'font-loading.test.mjs',
    'range-styles.test.mjs',
    'cross-sheet-style.test.mjs',
    'text-wrapping.test.mjs',
    'auto-fit.test.mjs',
    // Previously missing tests - added in Phase 3
    'borders.test.mjs',
    'bug-a-repro.test.mjs',
    'cross-sheet-formula-edit.test.mjs',
    'cursor.test.mjs',
    'custom-format.test.mjs',
    'format.test.mjs',
    'merged-cells.test.mjs',
    'multi-cell-format.test.mjs',
    'sheet-order.test.mjs',
    'spill.test.mjs',
