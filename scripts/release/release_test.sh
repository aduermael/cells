...
assert_ok "skill has no bazel" bash -c "! grep -Eiq 'bazel|Build from source|in this repository' '$proj/.agents/skills/cells/SKILL.md'"
assert_ok "skill description spreadsheet-focused" \
  bash -c "! grep -Eiq 'Luau scripting|automation|collaboration' '$proj/.agents/skills/cells/SKILL.md'"
