...
# xlsx_reader.cc, xlsx_writer.cc, and testdata/xlsx files are excluded because
# they depend on OpenXLSX which is a Bazel external dependency not available to
# clang-tidy
if [ ${#FILES[@]} -eq 0 ]; then
