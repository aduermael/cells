...
- [ ] 2a: Update header comment in `range_index.h` to remove mention of flag-specific indices
- [ ] 2b: Run existing tests to verify no regressions (`range_index_test.cc`)
