...
- [x] 7f: Export cell borders to XLSX during write. Added XLSXBorderEdgeEntry and XLSXBorderEntry structs, updated StyleTable to track borders, added borderStyleToXlsx() and writeBorderEdge() helpers, and updated generateStyles() to output borders section with proper borderId references.
